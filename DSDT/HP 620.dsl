 ...
 *
 * Disassembly of dsdt.dat, Thu Jun 19 07:58:36 2025
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001B62B (112171)
 ...
 */
DefinitionBlock ("", "DSDT", 1, "HPQOEM", "1526    ", 0x00000001)
{
    ...
    OperationRegion (GNVS, SystemMemory, 0xB9FC2D98, 0x0100)
    ...
    OperationRegion (ASMA, SystemMemory, 0xB9FBF018, 0x1060)
    Field (ASMA, AnyAcc, NoLock, Preserve)
    {
        ASMB,   33536
    }

    OperationRegion (AF10, SystemMemory, 0xB9FC1818, 0x07C9)
    ...
    OperationRegion (HPDF, SystemMemory, 0xB9FC6F18, 0x0057)
    ...
    OperationRegion (HPBR, SystemMemory, 0xB9FC6E98, 0x0045)
    ...
    Scope (\_GPE)
    {
        ...
        Method (_L02, 0, NotSerialized)  // _Lxx: Level-Triggered GPE, xx=0x00-0xFF
        {
            ...
            If (Local0)
            {
                ...
                If ((Local0 == 0x07))
                {
                    Acquire (\_TZ.THER, 0xFFFF)
                    \_TZ.THSC |= 0x01
                    Release (\_TZ.THER)
                    Notify (\_TZ.DTSZ, 0x80) // Thermal Status Change
                }
        ...
        Method (_L18, 0, NotSerialized)  // _Lxx: Level-Triggered GPE, xx=0x00-0xFF
        {
            ...
            Notify (\_SB.PCI0.USB6, 0x00) // Bus Check
        ...
        Method (_L1D, 0, NotSerialized)  // _Lxx: Level-Triggered GPE, xx=0x00-0xFF
        {
            Local0 = (GIV ^ 0x2000)
            GIV = Local0
            Local1 = (0x2000 * 0x2000)
            Local2 = (Local1 << 0x01)
            Local3 = (Local1 | Local2)
            Local0 = (\_SB.PCI0.LPCB.GPRO & ~Local3)
            \_SB.PCI0.LPCB.GPRO = Local0
            If (\_SB.PCI0.LPCB.EC0.ECRG)
            {
                \_SB.PCI0.LPCB.EC0.LIDS = (\_SB.LID._LID () ^ 0x01)
            }
            ...
            If (VLET ())
            {
                ...
                Local0 = (\_SB.PCI0.LPCB.GPRO & ~Local3)
                \_SB.PCI0.LPCB.GPRO = (Local0 | Local2)
            }
            ElseIf ((\WCOS () < 0x06))
            {
                Notify (\_SB.LID, 0x80) // Status Change
    ...
    Scope (\_TZ)
    {
        ...
        Method (TRUP, 0, Serialized)
        {
            ...
            ElseIf ((PRDT == 0x02))
            {
                TRIP [0x01] = MT10 /* \_TZ_.MT10 */
            }
            ElseIf ((PRDT == 0x03))
            {
                TRIP [0x01] = MT85 /* \_TZ_.MT85 */
            }
            ElseIf ((PRDT == 0x04))
            {
                TRIP [0x01] = PT90 /* \_TZ_.PT90 */
            }
        }
        ...
        Method (INTM, 1, Serialized)
        {
            If ((\_SB.PCI0.GFX0.GIVD == 0x00))
            {
                ...
                If (Arg0)
                {
                    Notify (\_TZ.CPUZ, 0x80) // Thermal Status Change
                    Notify (\_TZ.SKNZ, 0x80) // Thermal Status Change
                }
            }
            Else
            {
                ...
                {
                    Notify (\_TZ.CPUZ, 0x80) // Thermal Status Change
                    Notify (\_TZ.GFXZ, 0x80) // Thermal Status Change
                    Notify (\_TZ.SKNZ, 0x80) // Thermal Status Change
                }
            }
        }
        ...
        Name (LVTK, 0x00)
        Name (GFTH, 0x00)
        Method (IVTH, 0, Serialized)
        {
            LVTH = 0x00
            LVTK = 0x00
            GFTH = 0x00
            \_SB.PCI0.LPCB.SMAB (0x9A, 0x40, 0x03)
            \_SB.PCI0.LPCB.SMAB (0x9A, 0x25, 0x07)
            \_SB.PCI0.LPCB.SMAB (0x9A, 0x27, 0x12)
            Local1 = (\_TZ.GFXZ._AC0 () - 0x0AAC)
            Divide (Local1, 0x0A, Local0, Local2)
            Local2 += 0x03
            \_SB.PCI0.LPCB.SMAB (0x9A, 0x19, Local2)
            Local1 = (\_TZ.GFXZ._CRT () - 0x0AAC)
            Divide (Local1, 0x0A, Local0, Local2)
            Local2 += 0x01
            \_SB.PCI0.LPCB.SMAB (0x9A, 0x19, Local2)
            \_SB.PCI0.LPCB.SMAB (0x9A, 0x0B, 0x7F)
            \_SB.PCI0.LPCB.SMAB (0x9A, 0x0C, 0x00)
            \_SB.PCI0.LPCB.SMAB (0x9A, 0x07, 0x6F)
            \_SB.PCI0.LPCB.SMAB (0x9A, 0x13, 0x00)
            \_SB.PCI0.LPCB.SMAB (0x9A, 0x08, 0x00)
            \_SB.PCI0.LPCB.SMAB (0x9A, 0x14, 0x00)
            \_SB.PCI0.LPCB.SMAB (0x9A, 0x0E, 0x88)
            \_SB.PCI0.LPCB.SMAB (0x9A, 0x0D, 0x11)
            \_SB.PCI0.LPCB.SMAB (0x9A, 0x0A, 0x04)
            \_SB.PCI0.LPCB.SMAB (0x9A, 0x09, 0x00)
            \_SB.PCI0.LPCB.SMAB (0x9A, 0x21, 0x0A)
        }

        PowerResource (PFN6, 0x00, 0x0000)
        {
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                Return (FAST (0x01, 0x00))
            }
        ...
        PowerResource (PFN7, 0x00, 0x0000)
        {
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                Return (FAST (0x01, 0x01))
            }
        ...
        PowerResource (PFN8, 0x00, 0x0000)
        {
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                Return (FAST (0x01, 0x02))
            }
        ...
        PowerResource (PFN9, 0x00, 0x0000)
        {
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                Return (FAST (0x01, 0x03))
            }
        ...
        PowerResource (PFNA, 0x00, 0x0000)
        {
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                Return (FAST (0x01, 0x04))
            }
        ...
        PowerResource (PFNB, 0x00, 0x0000)
        {
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                Return (FAST (0x01, 0x05))
            }
        ...
        PowerResource (PGF0, 0x00, 0x0000)
        {
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                Return (GFTH) /* \_TZ_.GFTH */
            }

            Method (_ON, 0, NotSerialized)  // _ON_: Power On
            {
                If (((GFTH == 0x00) && (LVTH == 0x00)))
                {
                    If ((LVTK >= \_TZ.GFXZ._AC0 ()))
                    {
                        \_SB.SSMI (0xEA74, 0x03, 0x01, 0x00, 0x00)
                        LVTH = 0x01
                    }
                }
            ...
            Method (_OFF, 0, NotSerialized)  // _OFF: Power Off
            {
                If ((GFTH && LVTH))
                {
                    If ((LVTK < \_TZ.GFXZ._AC0 ()))
                    {
                        \_SB.SSMI (0xEA74, 0x03, 0x00, 0x00, 0x00)
                        LVTH = 0x00
                    }
                }
        ...
        ThermalZone (GFXZ)
        {
            ...
            Method (_TMP, 0, Serialized)  // _TMP: Temperature
            {
                ...
                {
                    Local2 = (VGST & 0xFF)
                    Local6 = ((VGST >> 0x08) & 0xFF)
                    \_SB.PCI0.LPCB.SMAB (0x9A, 0x0E, Local2)
                    \_SB.PCI0.LPCB.SMAB (0x9A, 0x0D, Local6)
                    VGST = 0x00
        ...
        Method (THEV, 0, Serialized)
        {
            If ((\_SB.PCI0.GFX0.GIVD == 0x00))
            {
                ...
                If ((Local1 & 0x08))
                {
                    Notify (SKNZ, 0x80) // Thermal Status Change
                }
            }
            Else
            {
                ...
                Local3 = 0x0E
                Local0 = \_SB.PCI0.LPCB.SMAB (0x99, 0x02, 0x00)
                Local2 = \_SB.PCI0.LPCB.SMAB (0x9B, 0x02, 0x00)
                If (((Local0 & 0xFF00) == 0x00))
                {
                    If ((Local0 & 0x18))
                    {
        ...
        Name (VGGT, 0x0C3C)
        Name (VGST, 0x00)
        Method (FAST, 2, Serialized)
        {
            Local1 = (0x01 << Arg1)
            If ((DerefOf (CUFA [Arg0]) & Local1))
            {
                Local0 = 0x01
            }
            Else
        ...
        Method (FOOF, 3, Serialized)
        {
            Local4 = DerefOf (CUFA [Arg1])
            Local1 = Local4
            Local0 = (0x01 << Arg2)
            If ((Arg0 == 0x01))
            {
        ...
        Method (GETP, 2, Serialized)
        {
            ...
            Local2 = DerefOf (DerefOf (DerefOf (TRIP [CATZ (Arg1)]) [
                Local0]) [Local1])
            Return (Local2)
        }
        ...
        Method (GEDT, 0, Serialized)
        {
            ...
            While ((Local1 < Local0))
            {
                If (Local1)
                {
                    ...
                    Local4 *= 0x0A
                    Local4 += 0x0AAC
                    DerefOf (DerefOf (TRIP [CATZ (0x00)]) [0x00]) [
                        Local1] = Local4
                }
                ...
                Local4 *= 0x0A
                Local4 += 0x0AAC
                DerefOf (DerefOf (TRIP [CATZ (0x00)]) [0x01]) [
                    Local1] = Local4
                Local1++
            }
        }
        ...
        Method (INTS, 2, Serialized)
        {
            ...
            Else
            {
                Local1 = (\_TZ.CPUZ._AC0 () - 0x0AAC)
                Divide (Local1, 0x0A, Local0, Local2)
                Local2 = ADCT (Local2, 0x01)
                Local2 += 0x03
            }
            ...
            \_SB.PCI0.LPCB.EC0.KFCL (0x00, MIFA)
        }
        ...
        Method (GTTP, 1, Serialized)
        {
            If ((Arg0 < 0x04))
            {
                ...
                Else
                {
                    If ((Arg0 == 0x03))
                    {
                        Local2 = \_SB.PCI0.LPCB.SMAB (0x99, 0x00, 0x00)
                    }

                    If ((Arg0 == 0x02))
                    {
                        Local2 = VGGT /* \_TZ_.VGGT */
                    }

                    If ((Arg0 == 0x01))
                    {
                        Local2 = \_SB.PCI0.LPCB.SMAB (0x99, 0x01, 0x00)
                        If (((Local2 & 0xFF00) == 0x00))
                        {
                            Local2 = ADCT (Local2, 0x00)
                        }
                    }
            ...
            If ((THSC & Local2))
            {
                ...
                If ((WHTR & Local2))
                {
                    Local0 = Match (DerefOf (DerefOf (TRIP [CATZ (Arg0)]) [0x01]
                        ), MGT, Local1, MTR, 0x00, 0x00)
                }
                Else
                {
                    Local0 = Match (DerefOf (DerefOf (TRIP [CATZ (Arg0)]) [0x00]
                        ), MGE, Local1, MTR, 0x00, 0x00)
                    Local0--
                    WHTR |= Local2
                }

                If (((Local0 != DerefOf (CUZO [Arg0])) || SCPC))
                {
                    SCPC = 0x00
                    CUZO [Arg0] = Local0
                    If ((Arg0 == 0x00))
                    {
                        Notify (\_TZ.DTSZ, 0x81) // Thermal Trip Point Change
                    }
                    ElseIf ((Arg0 < 0x04))
                    {
                        SETM (Local0, Arg0)
        ...
        {
            Local0 = DerefOf (DerefOf (DerefOf (TRIP [CATZ (Arg1)]) [
                0x01]) [Arg0])
            Local0 -= 0x0AAC
            Divide (Local0, 0x0A, Local1, Local6)
            If (((Arg1 == 0x01) && (Local6 < 0x7F)))
            {
                Local6 = ADCT (Local6, 0x01)
            }
            ...
            If ((Arg1 == 0x01))
            {
                \_SB.PCI0.LPCB.SMAB (0x98, 0x0E, Local2)
                \_SB.PCI0.LPCB.SMAB (0x98, 0x0D, Local6)
            ...
            If ((Arg1 == 0x03))
            {
                \_SB.PCI0.LPCB.SMAB (0x98, 0x0C, Local2)
                \_SB.PCI0.LPCB.SMAB (0x98, 0x0B, Local6)
                Notify (\_TZ.SKNZ, 0x81) // Thermal Trip Point Change
            }
        }
        ...
        PowerResource (PFN5, 0x00, 0x0000)
        {
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                Return (FAST (0x00, 0x05))
            }
        ...
        ThermalZone (CPUZ)
        {
            ...
            Method (_AC2, 0, NotSerialized)  // _ACx: Active Cooling, x=0-9
            {
                Return (GETP (0x03, 0x01))
            }

            Method (_AC3, 0, NotSerialized)  // _ACx: Active Cooling, x=0-9
            {
                Return (GETP (0x02, 0x01))
            }
            ...
            Method (_AC5, 0, NotSerialized)  // _ACx: Active Cooling, x=0-9
            {
                Return (GETP (0x00, 0x01))
            }

            Method (_PSV, 0, NotSerialized)  // _PSV: Passive Temperature
            {
                Return (GETP (0x06, 0x01))
            }
    ...
    Scope (\_SB)
    {
        Device (PCI0)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                Local1 = (0x10000000 >> ^MCHC.PXSZ) /* \_SB_.PCI0.MCHC.PXSZ */
                M2MN = (Local0 + Local1)
                M2LN = ((M2MX - M2MN) + 0x01)
            ...
            Device (PEGP.DGFX)
            {
                ...
                Method (_DOD, 0, NotSerialized)  // _DOD: Display Output Devices
                {
                    ...
                    DODS [0x02] = (0x00010000 | DerefOf (DIDX [0x02]))
                    DODS [0x03] = (0x00010000 | DerefOf (DIDX [0x03]))
                    DODS [0x04] = (0x00010000 | DerefOf (DIDX [0x04]))
            ...
            Scope (\)
            {
                OperationRegion (IO_T, SystemIO, 0x1010, 0x10)
            ...
            Device (USB1)
            {
                ...
                OperationRegion (UHCX, PCI_Config, 0xC4, 0x04)
                Field (UHCX, AnyAcc, NoLock, Preserve)
                {
                    P0EN,   1, 
                    P1EN,   1
                }
            ...
            Device (LPCB)
            {
                ...
                Device (LNKA)
                {
                    ...
                    Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                    {
                        ...
                        CreateWordField (RTLA, \_SB.PCI0.LPCB.LNKA._CRS._Y14._INT, IRQ0)  // _INT: Interrupts
                        IRQ0 = Zero
                        IRQ0 = (0x01 << (PARC & 0x0F))
                ...
                Device (LNKB)
                {
                    ...
                    Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                    {
                        ...
                        CreateWordField (RTLB, \_SB.PCI0.LPCB.LNKB._CRS._Y15._INT, IRQ0)  // _INT: Interrupts
                        IRQ0 = Zero
                        IRQ0 = (0x01 << (PBRC & 0x0F))
                ...
                Device (LNKC)
                {
                    ...
                    Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                    {
                        ...
                        CreateWordField (RTLC, \_SB.PCI0.LPCB.LNKC._CRS._Y16._INT, IRQ0)  // _INT: Interrupts
                        IRQ0 = Zero
                        IRQ0 = (0x01 << (PCRC & 0x0F))
                ...
                Device (LNKD)
                {
                    ...
                    Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                    {
                        ...
                        CreateWordField (RTLD, \_SB.PCI0.LPCB.LNKD._CRS._Y17._INT, IRQ0)  // _INT: Interrupts
                        IRQ0 = Zero
                        IRQ0 = (0x01 << (PDRC & 0x0F))
                ...
                Device (LNKE)
                {
                    ...
                    Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                    {
                        ...
                        CreateWordField (RTLE, \_SB.PCI0.LPCB.LNKE._CRS._Y18._INT, IRQ0)  // _INT: Interrupts
                        IRQ0 = Zero
                        IRQ0 = (0x01 << (PERC & 0x0F))
                ...
                Device (LNKF)
                {
                    ...
                    Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                    {
                        ...
                        CreateWordField (RTLF, \_SB.PCI0.LPCB.LNKF._CRS._Y19._INT, IRQ0)  // _INT: Interrupts
                        IRQ0 = Zero
                        IRQ0 = (0x01 << (PFRC & 0x0F))
                ...
                Device (LNKG)
                {
                    ...
                    Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                    {
                        ...
                        CreateWordField (RTLG, \_SB.PCI0.LPCB.LNKG._CRS._Y1A._INT, IRQ0)  // _INT: Interrupts
                        IRQ0 = Zero
                        IRQ0 = (0x01 << (PGRC & 0x0F))
                ...
                Device (LNKH)
                {
                    ...
                    Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                    {
                        ...
                        CreateWordField (RTLH, \_SB.PCI0.LPCB.LNKH._CRS._Y1B._INT, IRQ0)  // _INT: Interrupts
                        IRQ0 = Zero
                        IRQ0 = (0x01 << (PHRC & 0x0F))
                ...
                Device (EC0)
                {
                    ...
                    Method (UHSW, 0, Serialized)
                    {
                        If ((INQW == 0x00))
                        {
                            If ((\WCOS () >= 0x06))
                            {
                                ...
                                If (ECRG)
                                {
                                    HSEN = HSWK /* \_SB_.PCI0.LPCB.EC0_.HSWK */
                                }
                    ...
                    Method (CHSW, 1, Serialized)
                    {
                        ...
                        If (ECRG)
                        {
                            Local0 = HSST /* \_SB_.PCI0.LPCB.EC0_.HSST */
                            Local1 = (Local0 & Arg0)
                            If (Local1)
                            {
                                HSST = (Local0 & ~Arg0)
                    ...
                    Method (BTIF, 1, Serialized)
                    {
                        ...
                        If (ECRG)
                        {
                            ...
                            If ((\WCOS () > 0x06))
                            {
                                Local0 = BDC /* \_SB_.PCI0.LPCB.EC0_.BDC_ */
                            }
                    ...
                    Method (GBTI, 1, NotSerialized)
                    {
                        ...
                        If (ECRG)
                        {
                            If ((BATP & (0x01 << Arg0)))
                            {
                                ...
                                CreateField (DerefOf (Local0 [0x02]), (0x2C * 0x08), (SizeOf (
                                    Local1) * 0x08), BMAN)
                                BMAN = Local1
                            }
                            Else
                    ...
                    Method (_Q05, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
                    {
                        ...
                        \_TZ.THSC |= 0x10
                        Release (\_TZ.THER)
                        Notify (\_TZ.BATZ, 0x80) // Thermal Status Change
                    }
                ...
                Device (SIO)
                {
                    ...
                    Device (HCOM)
                    {
                        ...
                        Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                        {
                            ...
                            CreateWordField (CMRS, \_SB.PCI0.LPCB.SIO.HCOM._CRS._Y1D._MIN, MIN1)  // _MIN: Minimum Base Address
                            CreateWordField (CMRS, \_SB.PCI0.LPCB.SIO.HCOM._CRS._Y1D._MAX, MAX1)  // _MAX: Maximum Base Address
                            Local1 = GETR (0x02)
                    ...
                    Device (COM1)
                    {
                        ...
                        Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                        {
                            ...
                            CreateWordField (CRES, \_SB.PCI0.LPCB.SIO.COM1._CRS._Y1E._MIN, MIN1)  // _MIN: Minimum Base Address
                            CreateWordField (CRES, \_SB.PCI0.LPCB.SIO.COM1._CRS._Y1E._MAX, MAX1)  // _MAX: Maximum Base Address
                            CreateWordField (CRES, \_SB.PCI0.LPCB.SIO.COM1._CRS._Y1F._INT, IRQ0)  // _INT: Interrupts
                            If (RCOD)
                            {
                                Local0 = 0x00
                            }
                    ...
                    Device (LPT0)
                    {
                        ...
                        Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                        {
                            ...
                            CreateWordField (CRES, \_SB.PCI0.LPCB.SIO.LPT0._CRS._Y20._MIN, MIN1)  // _MIN: Minimum Base Address
                            CreateWordField (CRES, \_SB.PCI0.LPCB.SIO.LPT0._CRS._Y20._MAX, MAX1)  // _MAX: Maximum Base Address
                            CreateByteField (CRES, \_SB.PCI0.LPCB.SIO.LPT0._CRS._Y20._LEN, LEN1)  // _LEN: Length
                            CreateWordField (CRES, \_SB.PCI0.LPCB.SIO.LPT0._CRS._Y21._MIN, MIN2)  // _MIN: Minimum Base Address
                            CreateWordField (CRES, \_SB.PCI0.LPCB.SIO.LPT0._CRS._Y21._MAX, MAX2)  // _MAX: Maximum Base Address
                            CreateByteField (CRES, \_SB.PCI0.LPCB.SIO.LPT0._CRS._Y21._LEN, LEN2)  // _LEN: Length
                            CreateWordField (CRES, \_SB.PCI0.LPCB.SIO.LPT0._CRS._Y22._INT, IRQ0)  // _INT: Interrupts
                            CreateWordField (CRES, \_SB.PCI0.LPCB.SIO.LPT0._CRS._Y23._DMA, DMA0)  // _DMA: Direct Memory Access
                            If (RLPD)
                            {
                                Local0 = 0x00
                            }
                ...
                Device (PS2M)
                {
                    Name (_HID, EisaId ("SYN0176"))  // _HID: Hardware ID
            ...
            Method (_OSC, 4, NotSerialized)  // _OSC: Operating System Capabilities
            {
                ...
                If ((\SRCP (Local0, PUID) == 0x01))
                {
                    ...
                    If (!(CDW1 & 0x01))
                    {
                        Local4 = ((Local3 & 0x01) ^ 0x01)
                        Local5 = (((Local3 >> 0x02) & 0x01) ^ 0x01)
            ...
            Scope (LPCB)
            {
                OperationRegion (LPC1, PCI_Config, 0x80, 0x3C)
            ...
            Scope (RP03)
            {
                ...
                Device (ECF0)
                {
                    ...
                    Method (_PRW, 0, Serialized)  // _PRW: Power Resources for Wake
                    {
                        Return (^^_PRW) /* \_SB_.PCI0.RP03._PRW */
                    }
                ...
                Scope (ECF0)
                {
                    Method (_EJD, 0, NotSerialized)  // _EJD: Ejection Dependent Device
                    {
                        Return ("\\_SB.PCI0.EHC1.RHUB.PRT2.HPT0")
                    }
                }
            }
            ...
            Scope (RP06)
            {
                ...
                Device (NIC)
                {
                    ...
                    OperationRegion (NPCI, PCI_Config, 0x00, 0x02)
                    Field (NPCI, WordAcc, NoLock, Preserve)
                    {
                        VEID,   16
                    }
            ...
            Scope (\_GPE)
            {
                ...
                Method (INIC, 0, Serialized)
                {
                    ...
                    If ((GPL0 & 0x0200))
                    {
                        Notify (\_SB.PCI0.RP06, 0x00) // Bus Check
                        Sleep (0xC8)
                        If ((\_SB.PCI0.RP06.NIC.VEID == 0x11AB))
                        {
                            Local1 = 0x00
                        }
                    }
        ...
        Name (WSIP, Buffer (0x07)
        {
             0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF         // .......
        })
        Name (BSOL, Package (0x01)
        {
            Package (0x1D)
            {
                "Boot Order", 
                " Optical Disk Drive, Hard Drive(C:), USB Floppy, USB CD-ROM, USB Hard Disk, Network Controller, SD Card, , , , , , , , , ,", 
        ...
        Name (ST02, Buffer (0x8C){})
        Name (WATS, Buffer (0x13){})
        ...
        Name (BISE, Package (0x8A)
        {
            ...
            Package (0x1A)
            {
                "Preboot Authentication on HP QuickLook", 
                " *Disable, Enable", 
                "\\System Configuration\\Device Configurations", 
                0x00, 
                0x01, 
            ...
            Package (0x1A)
            {
                "Internal Network Adapter Boot Security Level", 
                " *View, Change, Hide", 
                "\\System Configuration\\Security Level", 
                0x00, 
                0x01, 
            ...
            Package (0x1A)
            {
                "Internal Network Adapter Boot Mode Security Level", 
                " *View, Change, Hide", 
                "\\System Configuration\\Security Level", 
                0x00, 
                0x01, 
            ...
            Package (0x1A)
            {
                "Allow Reset of HP ProtectTools security keys Security Level", 
                " *View, Change, Hide", 
                "\\System Configuration\\Security Level", 
                0x00, 
                0x01, 
            ...
            Package (0x1A)
            {
                "Preboot Authentication on HP QuickLook Security Level", 
                " *View, Change, Hide", 
                "\\System Configuration\\Security Level", 
                0x00, 
                0x01, 
            ...
            Package (0x1A)
            {
                "Drivelock Password Security Level", 
                " *View, Change, Hide", 
                "\\System Configuration\\Security Level", 
                0x00, 
                0x01, 
        ...
        Device (WMID)
        {
            ...
            Method (WQBC, 1, NotSerialized)
            {
                ...
                If ((Local1 == 0x01))
                {
                    ...
                    If (\SRCM (ST01, "SATA Device Mode", 0x10))
                    {
                        ...
                        If (Local6)
                        {
                            DerefOf (BISE [Arg0]) [0x01] = ASTR /* \_SB_.ASTR */
                            DerefOf (BISE [Arg0]) [0x0C] = AHCI /* \_SB_.AHCI */
                        }
                        Else
                        {
                            DerefOf (BISE [Arg0]) [0x01] = ISTR /* \_SB_.ISTR */
                            DerefOf (BISE [Arg0]) [0x0C] = IDEC /* \_SB_.IDEC */
                        }
                    }
            ...
            Method (WQBE, 1, NotSerialized)
            {
                ...
                STAT &= 0x0F
                WBOR = BORD /* \BORD */
                CreateField (WBOR, 0x00, (0x07 * 0x08), CBOS)
                While ((Local1 != 0x07))
                {
            ...
            {
                \_SB.SSMI (0xEA7B, 0x00, 0x06, 0x00, 0x00)
                DerefOf (BSIN [0x00]) [0x0E] = PWDL /* \PWDL */
                If ((PWDL <= 0x09))
                {
                    Local2 = 0x01
                }
            ...
            Method (WQBJ, 1, NotSerialized)
            {
                ...
                If ((STAT == 0x00))
                {
                    ...
                    DerefOf (BUSR [Arg0]) [0x11] = ROLE /* \ROLE */
                    If ((HASH != 0x00))
                    {
                        DerefOf (BUSR [0x00]) [0x10] = 0x01
                        If ((Arg0 == 0x00))
                        {
                            DerefOf (BUSR [0x00]) [0x12] = SPSF /* \SPSF */
                        }
                        Else
                        {
                            DerefOf (BUSR [0x00]) [0x12] = 0x01
                        }
                    }
                    Else
                    {
            ...
            Method (WMBA, 3, NotSerialized)
            {
                If ((Arg1 == 0x01))
                {
                    ...
                    Local6 = 0x00
                    PCHG [0x00] = 0x00
                    If (\SRCM (ST01, "Boot Order Security Level", 0x19))
                    {
                        Local5 = 0x00
                    }
                    ElseIf (\SRCM (ST01, "Boot Order", 0x0A))
                    {
                        Local2--
            ...
            Method (WSDD, 1, NotSerialized)
            {
                ...
                Debug = Arg0
                Local0 = (Arg0 & (0x10 | (0x01 | (0x02 | (0x04 | 0x08
                    )))))
                Debug = Local0
                Debug = WDPE /* \WDPE */
                VSDD (Local0)
            ...
            {
                Debug = "GetWireless"
                \_SB.SSMI (0xEA75, 0x01, 0x05, 0x574D4953, 0x00)
                Debug = "Exit Wireless"
                Debug = EAX /* \EAX_ */
                Debug = EBX /* \EBX_ */
                Debug = ECX /* \ECX_ */
            ...
            {
                Debug = "SetWirelessState enter"
                Debug = Arg0
                \_SB.SSMI (0xEA75, 0x02, 0x05, 0x574D4953, 0x00)
                \_GPE.HWWP (0x00)
                Debug = EAX /* \EAX_ */
                Debug = EBX /* \EBX_ */
                Debug = ECX /* \ECX_ */
            ...
            Method (WGBN, 0, NotSerialized)
            {
                ...
                Local1 = Buffer (0x0C)
                    {
                        /* 0000 */  0x31, 0x01, 0xAE, 0x01, 0x9D, 0x01, 0xB6, 0x01,  // 1.......
                        /* 0008 */  0xB7, 0x01, 0x00, 0x00                           // ....
                    }
                Concatenate (Local1, Buffer (0x0A)
                    {
                        /* 0000 */  0xFF, 0xFF, 0x3B, 0x21, 0x6D, 0x20, 0xA9, 0x21,  // ..;!m .!
                        /* 0008 */  0x00, 0x00                                       // ..
                    }, Local2)
                Local3 = Package (0x03){}
                Local3 [0x00] = 0x00
            ...
            Method (HKFR, 0, NotSerialized)
            {
                ...
                If ((Local1 == 0x04))
                {
                    ...
                    DerefOf (Local0 [0x02]) [0x01] = 0x01
                    DerefOf (Local0 [0x02]) [0x02] = WDGN /* \WDGN */
                    DerefOf (Local0 [0x02]) [0x03] = WDSA /* \WDSA */
            ...
            {
                Local0 = 0x00
                \_SB.SSMI (0xEA79, 0x00, 0x00, 0x00, 0x00)
                If ((EBX != 0x00))
                {
                    Local1 = Buffer (0x06)
                        {
                    ...
                    Local1 [0x02] = (EBX & 0xFF)
                    Local1 [0x03] = ((EBX >> 0x08) & 0xFF)
                    Local1 [0x04] = ((EBX >> 0x10) & 0xFF)
                    Local1 [0x05] = ((EBX >> 0x18) & 0xFF)
                    Local0 += 0x06
                }

                \_SB.SSMI (0xEA79, 0x01, 0x00, 0x00, 0x00)
                If ((EBX != 0x00))
                {
                    Local2 = Buffer (0x06)
                        {
                    ...
                    Local2 [0x02] = (EBX & 0xFF)
                    Local2 [0x03] = ((EBX >> 0x08) & 0xFF)
                    Local2 [0x04] = ((EBX >> 0x10) & 0xFF)
                    Local2 [0x05] = ((EBX >> 0x18) & 0xFF)
                    If ((Local0 == 0x00))
                    {
                        Local1 = Local2
                    }
                ...
                \_SB.SSMI (0xEA79, 0x02, 0x00, 0x00, 0x00)
                If ((EBX != 0x00))
                {
                    Local2 = Buffer (0x06)
                        {
                ...
                Else
                {
                    Local4 = ((WABN << 0x14) + (WADN << 0x0F))
                    Local4 += (WAFN << 0x0C)
                    Local4 += 0xE0000000
                    OperationRegion (PCIR, SystemMemory, Local4, 0x40)
                    Field (PCIR, AnyAcc, NoLock, Preserve)
                    {
                        VIDL,   8, 
                        VIDH,   8, 
                    ...
                    If ((VIDL != 0xFF))
                    {
                        ...
                        Local2 [0x02] = VIDL /* \_SB_.WMID.GWID.VIDL */
                        Local2 [0x03] = VIDH /* \_SB_.WMID.GWID.VIDH */
                        Local2 [0x04] = DIDL /* \_SB_.WMID.GWID.DIDL */
                        Local2 [0x05] = DIDH /* \_SB_.WMID.GWID.DIDH */
                        Local2 [0x06] = SVIL /* \_SB_.WMID.GWID.SVIL */
                        Local2 [0x07] = SVIH /* \_SB_.WMID.GWID.SVIH */
                        Local2 [0x08] = SIDL /* \_SB_.WMID.GWID.SIDL */
                        Local2 [0x09] = SIDH /* \_SB_.WMID.GWID.SIDH */
                        If ((Local0 == 0x00))
                        {
                            Local1 = Local2
                        }
            ...
            Name (_WDG, Buffer (0x0118)
            {
                ...
                /* 0070 */  0x09, 0xE7, 0x51, 0x33, 0x42, 0x43, 0x8A, 0x00,  // ..Q3BC..
                /* 0078 */  0xE3, 0x08, 0x8D, 0x98, 0xF4, 0x68, 0x35, 0x4C,  // .....h5L
                /* 0080 */  0xAF, 0x3E, 0x6A, 0x1B, 0x81, 0x06, 0xF8, 0x3C,  // .>j....<
                /* 0088 */  0x42, 0x44, 0x19, 0x00, 0x46, 0x97, 0xEA, 0x14,  // BD..F...
    ...
    Method (\_SB.GCOP, 0, NotSerialized)
    {
        Local0 = 0x02
        If ((GPL0 & 0x0100))
        {
    ...
    Method (WKET, 1, Serialized)
    {
        Notify (\_SB.PCI0.LPCB.SIO.COM1, 0x00) // Bus Check
        If ((\_SB.PCI0.RP03.PDSX ^ IECP))
        {
            Notify (\_SB.PCI0.RP03, 0x00) // Bus Check
        }

        If ((\_SB.PCI0.RP05.PDSX ^ DECP))
        {
