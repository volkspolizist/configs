...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x00000013)
{
    ...
    External (_SB_.PCI0.IDE0.PRT2.OFLG, IntObj)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xDA86FE18, 0x01D1)
    ...
    Scope (\)
    {
        ...
        {
            /* 0000 */  0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
    ...
    Scope (_SB.PCI0.EHC2.RHUB.PRT1.PRT3)
    {
        ...
        Device (DCAM)
        {
            ...
            Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
            {
                Return (CAPD) /* \_SB_.PCI0.EHC2.RHUB.PRT1.PRT3.CAPD */
            }
        }
    }
