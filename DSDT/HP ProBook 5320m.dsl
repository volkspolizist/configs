 ...
 */
DefinitionBlock ("", "DSDT", 2, "HPQOEM", "149B    ", 0x00000001)
{
    /*
    ...
    OperationRegion (GNVS, SystemMemory, 0xBB784918, 0x0172)
    ...
    OperationRegion (ASMA, SystemMemory, 0xBB780018, 0x1060)
    Field (ASMA, AnyAcc, NoLock, Preserve)
    {
        ASMB,   33536
    }

    OperationRegion (AF10, SystemMemory, 0xBB782018, 0x08BF)
    ...
    OperationRegion (HPDF, SystemMemory, 0xBB783E18, 0x0163)
    ...
    OperationRegion (HPD2, SystemMemory, 0xBB6CAF18, 0x0058)
    ...
    OperationRegion (HPBR, SystemMemory, 0xBB77FF18, 0x007E)
    ...
    Scope (\_TZ)
    {
        ...
        Method (SETM, 4, Serialized)
        {
            ...
            If ((THSC & Local7))
            {
                ...
                Local3 = DerefOf (DerefOf (TRIP [CATZ (Arg0)]) [0x01])
                    ...
                    (Local0 < Local4)))
                {
                    ...
                    SCPC = 0x00
                    CUZO [Arg0] = Local0
                    Local4 = DerefOf (DerefOf (DerefOf (TRIP [CATZ (Arg0)]) [
                        0x01]) [Local0])
                    Local4 -= 0x0AAC
    ...
    Scope (\_SB)
    {
        Device (PCI0)
        {
            ...
            Scope (GFX0)
            {
                ...
                Scope (DD02)
                {
                    ...
                    Method (_BCM, 1, Serialized)  // _BCM: Brightness Control Method
                    {
                        ...
                        BRIG = Arg0
                        Local1 = Match (DerefOf (\_SB.BCLS [\_SB.BCLI]), MGE, Arg0, MTR, 0x00, 
                            0x02)
                        If ((Local1 == Ones))
                        {
                            Local1 = (SizeOf (DerefOf (\_SB.BCLS [\_SB.BCLI])) - 0x01)
                        }
            ...
            Device (LPCB)
            {
                ...
                Device (PS2M)
                {
                    Name (_HID, EisaId ("SYN0161"))  // _HID: Hardware ID
        ...
        Name (BSOL, Package (0x02)
        {
            ...
            {
                "Boot Order", 
                " Optical Disk Drive, Hard Drive(C:), USB Floppy, USB CD-ROM, USB Hard Disk, Network Controller, SD Card, Dock Upgrade Bay, , , , , , , , ,", 
        ...
        Device (WMID)
        {
            ...
            Method (HPMC, 1, NotSerialized)
            {
                ...
                If ((Arg0 == 0x01))
                {
                    ...
                    While ((Local2 < 0x09))
                    {
                        Local0 [Local2] = DerefOf (Local1 [Local2])
                        Local2++
                    }
                    ...
                    If ((PMCS == 0x01))
                    {
                        If (\_SB.PCI0.LPCB.EC0.ECRG)
                        {
                            ...
                            Else
                            {
                                ...
                                Local4 = ((Local1 * Local4) + (Local2 * 0x0190))
            ...
            Method (WMBA, 3, NotSerialized)
            {
                If ((Arg1 == 0x01))
                {
                    ...
                    ElseIf ((\SRCM (ST01, "Boot Order", 0x0A) || \SRCM (ST01, "UEFI Boot Order", 0x0F)))
                    {
                        Local2--
            ...
            Name (_WDG, Buffer (0x0118)
            {
                ...
                /* 0070 */  0x09, 0xE7, 0x51, 0x33, 0x42, 0x43, 0xAD, 0x00,  // ..Q3BC..
    ...
    OperationRegion (HDC, SystemMemory, (0xFFFFFF00 & \_SB.PCI0.HDEF.BAR), 0x69)
    Field (HDC, AnyAcc, NoLock, Preserve)
    {
        Offset (0x08), 
        CR,     1, 
        Offset (0x60), 
    ...
    OperationRegion (HDEM, SystemMemory, 0xE00D8000, 0x05)
    Field (HDEM, AnyAcc, NoLock, Preserve)
    {
        Offset (0x04), 
        PCMD,   8
    }

    Method (S3WV, 1, Serialized)
    {
        If ((Arg0 == 0x03))
        {
            Local1 = PCMD /* \PCMD */
